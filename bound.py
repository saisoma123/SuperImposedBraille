...
SET JSON CREDENTIALS: set GOOGLE_APPLICATION_CREDENTIALS=DotBot-8960b00025c3.json
TO RUN: python bound.py in.png -out_file out.png 
Example:
    python doctext.py resources/text_menu.jpg 

    python bound_-_copy.py gbm.png -out_file out.png 
